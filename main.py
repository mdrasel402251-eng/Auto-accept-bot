...
async def cmd_start(message: types.Message):
    ...
    welcome_text = (
        ...
        "3. Enable 'Approve New Members' option in invite link ✅\n\n"
...
async def on_leave(event: ChatMemberUpdated):
    ...
    try:
        ...
        if row:
            ...
            link = await event.chat.export_invite_link()

        leave_msg = (
            f"👋 You left {event.chat.title}\n\n"
            f"🔗 Rejoin Link:\n{link}"
        )
...
async def main():
    ...
    print("✅ Auto Approval Bot Running Successfully!")
